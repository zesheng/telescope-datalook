Template.d4g_user_edit.helpers({
  ...
  hasNotificationsUsers : function(){
    return Users.getSetting('notifications.users', '', this) ? 'checked' : '';
  },
  hasNotificationsPosts : function(){
    return Users.getSetting('notifications.posts', '', this) ? 'checked' : '';
  },
  hasNotificationsComments : function(){
    return Users.getSetting('notifications.comments', '', this) ? 'checked' : '';
  },
  hasNotificationsReplies : function(){
    return Users.getSetting('notifications.replies', '', this) ? 'checked' : '';
  },
